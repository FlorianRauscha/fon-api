/**
 * L1 — Arbeitnehmerveranlagung (employee tax assessment), tax year 2023.
 * Source: schemas/l1/2023/BMF_XSD_Schema_Arbeitnehmerveranlagung_2023.xsd
 *
 ...
 * BMF L1 2023 XSD via libxml2 (see test/l1/2023/xsd-conformance.test.ts).
 */
...
export interface TypedAbBehindSelf {
	...
	kfzS?: "J";
	/** AUS29B_S — § 29b VwGH (außergewöhnliche Belastung) flag (2022 only, "J"). */
	aus29bS?: "J";
	kz435?: number;
	kz476?: number;
	kz439?: number;
...
export interface TypedAbBehindPartner {
	...
	pflegePe?: string;
	kfzP?: "J";
	/** AUS29B_P — § 29b VwGH (außergewöhnliche Belastung) flag (2022 only, "J"). */
	aus29bP?: "J";
	kz436?: number;
	kz417?: number;
	kz418?: number;
...
export interface FbMonth {
	...
	fb100?: "J";
	/** FB{n}_WS — Wohnsitzstaat in this month (BMF country code, 2022 only). */
	ws?: string;
}
